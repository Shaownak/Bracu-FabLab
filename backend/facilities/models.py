...
class Equipment(models.Model):
    ...
    user_manual = models.FileField(upload_to='equipment/manuals/', blank=True, null=True)
    requires_training = models.BooleanField(default=False)
    required_certification = models.ForeignKey(
        'trainings.TrainingCourse', on_delete=models.SET_NULL,
        blank=True, null=True, related_name='required_for_equipment'
    )
