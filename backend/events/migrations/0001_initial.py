    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_type', models.CharField(choices=[('workshop', 'Workshop'), ('hackathon', 'Hackathon'), ('competition', 'Competition'), ('lecture', 'Guest Lecture'), ('maker_fair', 'Maker Fair')], max_length=20)),
