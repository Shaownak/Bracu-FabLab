...
from .serializers import (
    ...
    BookingCreateSerializer, BookingApprovalSerializer,
)
...
class BookingDetailView(generics.RetrieveUpdateAPIView):
    queryset = Booking.objects.select_related('user', 'equipment').prefetch_related('history')
...
class BookingCancelView(APIView):
    ...
    def post(self, request, pk):
        try:
            booking = Booking.objects.get(pk=pk, user=request.user, status__in=['pending', 'approved'])
        except Booking.DoesNotExist:
