    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qr_code', models.ImageField(blank=True, null=True, upload_to='bookings/qrcodes/')),
                ...
                ('equipment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bookings', to='facilities.equipment')),
        ...
        migrations.AddIndex(
            model_name='booking',
            index=models.Index(fields=['date', 'equipment'], name='bookings_bo_date_16e76d_idx'),
        ),
        migrations.AddIndex(
            model_name='booking',
