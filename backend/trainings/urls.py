...
urlpatterns = [
    ...
    path('courses/<slug:slug>/', views.TrainingCourseDetailView.as_view(), name='training_detail'),
    path('courses/<uuid:pk>/progress/', views.UpdateProgressView.as_view(), name='update_progress'),
